...
/// Get mode from standard input
///
/// Get mode from standard input and returns `Mode` or raise `InputError`
pub fn get_mode() -> Result<Mode, InputError> {
    let stdin = stdin();
    let mut mode = String::new();

    println!("Enter in which mode you want to start (client, server or web):");
...
/// Get operation type
///
/// Get operation type from std input and returns `InputOperationType` or raise `InputError`
...
/// Get address from standard input
///
/// Get address from standard input and return it as a `String` or raise `InputError`
...
/// Get user from standard input
///
/// Get user from standard input and return it as a`String` or raise `InputError`
...
/// Check if provided address is valid for TCP
/// 
/// Check if provided address is valid for TCP and returns true if yes otherwise returns InputError
